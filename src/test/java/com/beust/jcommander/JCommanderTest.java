...
public class JCommanderTest {
  ...
  /**
   * Confirm that List<?> parameters with alternate names return the correct List regardless of how
  ...
  @Test(
      ...
      expectedExceptionsMessageRegExp =
          "Cannot use final field .*#_foo as a parameter;"
  ...
  public void hiddenArgs() {
    JCommander.newBuilder()
        .addObject(new HiddenArgs())
        .build()
        .parse("--input", "/tmp/a", "--output", "/tmp/b");
  }
  ...
  public void booleanNoDefault() {
    ...
    Args args = new Args();
    JCommander.newBuilder().addObject(args).build().parse("--f");
  ...
  public void invertedBoolean() {
    ...
    Args args = new Args();
    JCommander.newBuilder().addObject(args).args(new String[] {"--f"}).build();
  ...
  public void commandsShouldBeShownInOrderOfInsertion() {
    verifyCommandOrdering(
        new String[] {"add", "commit"}, new Object[] {new CommandAdd(), new CommandCommit()});
    verifyCommandOrdering(
        new String[] {"commit", "add"}, new Object[] {new CommandCommit(), new CommandAdd()});
  }
    ...
    public void validate(String name, String value) throws ParameterException {
      if (value.contains("\0"))
        throw new ParameterException(
            "this message comes from the validator (not from the converter)");
    }
  }
  ...
  @Test(
      expectedExceptions = ParameterException.class,
      expectedExceptionsMessageRegExp =
          "Was passed main parameter '' but no main parameter was defined.*")
  public void tmp() {
    class A {
      @Parameter(names = "-b")
      public String b;
  ...
  @Test(
      expectedExceptions = ParameterException.class,
      expectedExceptionsMessageRegExp = "\"--b\": couldn't convert \"ThisIsATest\" to an integer")
  ...
  public void dashDashEmpty() {
    class Parameters {
      @Parameter public List<String> mainParameters = new ArrayList<>();
    }
  ...
  public void dashDashParameter() {
    class Parameters {
      ...
      @Parameter public List<String> mainParameters;
    }
    ...
    JCommander.newBuilder()
        .addObject(args)
        .build()
        .parse("-name", "theName", "--", "param1", "param2");
  ...
  public void dashDashParameter2() {
    ...
    JCommander.newBuilder()
        .addObject(args)
        .build()
        .parse("param1", "param2", "--", "param3", "-name", "theName");
  ...
  @Test(
      expectedExceptions = ParameterException.class,
      expectedExceptionsMessageRegExp = ".*strictly.*")
  public void issue() {
    class Parameters {
      @Parameter(
          names = {"-v", "--values"},
  ...
  public void arity() {
    ...
    Parameters args = new Parameters();
    JCommander.newBuilder().addObject(args).args(new String[] {"--mv", "from", "to"}).build();
  ...
  public void mainParameterWithNonListField() {
    class Args {
      @Parameter private String main;
    }

    Args args = new Args();
    JCommander.newBuilder().addObject(args).args(new String[] {"a"}).build();
  ...
  public void mainParameterWithNonListFieldWithException() {
    ...
    Args args = new Args();
    JCommander.newBuilder().addObject(args).args(new String[] {"a", "b"}).build();
  }
  ...
  public void trimTest() {
    class Args {
      @Parameter(
          names = {"-L", "--replace-new-line"},
          description = "Char used for replacing new line in value")
      protected String escapeNl;
    }
    Args args = new Args();
    JCommander.newBuilder().addObject(args).build().parse("-L", " ");
  ...
  public void ignoreDefaultValueForRequiredParameter() {
    class Parameters {
      @Parameter(names = "-v", required = true, validateValueWith = StrictlyPositiveInteger.class)
      private int value;
    }
  ...
  static class StrictlyPositiveInteger implements IValueValidator<Integer> {
    ...
    public void validate(String name, Integer i) throws ParameterException {
      if (i <= 0) {
        throw new ParameterException(
            "Parameter " + name + " should be strictly positive (found " + i + ")");
      }
    }
  }
  ...
  public void javaTimeTest() {
    ...
    Assert.assertEquals(
        ...
        "LocalDateTime parsed incorrectly");
