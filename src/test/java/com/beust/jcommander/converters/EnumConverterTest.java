/**
 * Copyright (C) 2024 the original author or authors. See the notice.md file distributed with this
...
public class EnumConverterTest {
  private static final EnumConverter<Season> SEASON_ENUM_CONVERTER =
      new EnumConverter<>("", Season.class);

  private static final EnumConverter<Resolution> RESOLUTION_ENUM_CONVERTER =
      new EnumConverter<>("", Resolution.class);
