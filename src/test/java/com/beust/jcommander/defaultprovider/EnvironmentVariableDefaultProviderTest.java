...
public final class EnvironmentVariableDefaultProviderTest {
  ...
  public final void shouldParseEnvironmentVariable() {
    // given
    final Function<String, String> variableResolver =
        name ->
            "--some-option --simple-value ABC --quoted-value 'A BC' --double-quoted-value \"AB C\"";
    final IDefaultProvider defaultProvider =
        new EnvironmentVariableDefaultProvider(null, "-", variableResolver);
