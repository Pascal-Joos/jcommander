/**
 * Copyright (C) 2025 the original author or authors. See the notice.md file distributed with this
...
public final class SequenceDefaultProviderTest {
  ...
  public final void shouldProvideFirstNonNullValue() {
    ...
    final IDefaultProvider defaultProvider =
        IDefaultProvider.sequenceOf(always(null), always("one"), always("two"));
  ...
  public final void shouldProvideNullWhenNoProviderProducesSomeValue() {
    // given
    final IDefaultProvider defaultProvider =
        IDefaultProvider.sequenceOf(always(null), always(null), always(null));
