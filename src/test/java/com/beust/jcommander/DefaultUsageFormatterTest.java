...
public class DefaultUsageFormatterTest {
  ...
  /**
   * Returns a resource bundle for the en_US locale, this is to prevent needing an exhaustive list
   * of locales to allow the related tests to run on foreign machines.
   *
  ...
  public void testOutputFormat() {
    ...
    JCommander jc = JCommander.newBuilder().addObject(new ArgsTemplate()).build();
  ...
  public void testLongMainParameterDescription() {
    // setup
    JCommander jc =
        JCommander.newBuilder().addObject(new ArgsLongMainParameterDescription()).build();
    StringBuilder sb = new StringBuilder();
  ...
  public void testLongCommandDescription() throws Exception {
    // setup
    JCommander jc = JCommander.newBuilder().addCommand(new ArgsLongCommandDescription()).build();
    StringBuilder sb = new StringBuilder();
  ...
  public void testDescriptionWrappingLongWord() {
    // setup
    StringBuilder sb = new StringBuilder();
    final JCommander jc = JCommander.newBuilder().addObject(new ArgsLongDescription()).build();
  ...
  public void dontShowOptionUsageIfThereAreNoOptions() {
    class CommandTemplate {
      @Parameter List<String> parameters = new ArrayList<>();
    }

    CommandTemplate template = new CommandTemplate();
    JCommander jcommander = JCommander.newBuilder().addObject(template).build();
  ...
  public void annotationsAndDynamicParameters() {
    ...
    JCommander jc = JCommander.newBuilder().addObject(new DSimple()).build();
  ...
  public void noParseConstructor() {
    JCommander jCommander = JCommander.newBuilder().addObject(new ArgsMainParameter1()).build();
  ...
  /**
   * Test a use case where there are required parameters, but you still want to interrogate the
  ...
  public void oom() {
    JCommander jc = JCommander.newBuilder().addObject(new ArgsOutOfMemory()).build();
    jc.getUsageFormatter().usage(new StringBuilder());
  }
  ...
  public void usageCommandsUnderUsage() {
    ...
    JCommander c = JCommander.newBuilder().addObject(a).build();
