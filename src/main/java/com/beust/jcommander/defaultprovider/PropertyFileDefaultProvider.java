...
public class PropertyFileDefaultProvider implements IDefaultProvider {
  ...
  private static final Function<String, String> DEFAULT_OPTION_NAME_TRANSFORMER =
      optionName -> {
        int index = 0;
  ...
  public PropertyFileDefaultProvider(
      final String fileName, final Function<String, String> optionNameTransformer) {
    init(fileName);
  ...
  public PropertyFileDefaultProvider(
      final Path path, final Function<String, String> optionNameTransformer) {
