...
public @interface Parameter {
  ...
  /**
   * The string converter to use for this field. If the field is of type List and not listConverter
   * attribute was specified, JCommander will split the input in individual values and convert each
   * of them separately.
   */
   ...
   * List and the converter needs to return a List that's compatible with that type.
   */
  ...
  /**
   * What splitter to use (applicable only on fields of type List). By default, a comma separated
  ...
  /**
   * If true, this parameter can not be overwritten through a file or another appearance of the
   * parameter
   *
   * @return nc
   */
  ...
  /**
   * If specified, this number will be used to order the description of this parameter when usage()
   * is invoked.
   *
   * @return
   */
  ...
  /**
   * If specified, the category name will be used to order the description of this parameter when
   * usage() is invoked before the number order() is used.
   *
  ...
  /**
   * If specified, the placeholder (e.g. {@code "<filename>"}) will be shown in the usage() output
   * as a required parameter after the switch (e.g. {@code -i <filename>}).
   *
