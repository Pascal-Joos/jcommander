...
/**
 * Converts a String to a Date. TODO Modify to work with all valid ISO 8601 date formats (currently
 * only works with yyyy-MM-dd).
 *
  ...
  public Date convert(String value) {
    try {
      ...
      throw new ParameterException(
          getErrorString(
              value, String.format("an ISO-8601 formatted date (%s)", DATE_FORMAT.toPattern())));
    }
  }
}
