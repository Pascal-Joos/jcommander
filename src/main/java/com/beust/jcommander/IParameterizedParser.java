 ...
 * JCommander annotations, to be replaced at runtime for cases where the source code cannot be
 * directly annotated with JCommander annotations, but may have other annotations such as JSON
 * annotations that can be used to reflect as JCommander parameters.
 *
